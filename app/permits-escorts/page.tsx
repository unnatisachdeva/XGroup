...
export const metadata: Metadata = {
  title: "Permits & Escorts | Regulatory Guidance",
  description:
    "Permits and escort vehicle regulations, axle weight guidance, and regional transportation permits across Canada and the United States from The X Group Inc.",
};

export default function PermitsEscortsPage() {
  return (
    <div className="flex flex-col w-full">
      {/* Hero */}
      <Hero
        height="compact"
        eyebrow="PERMITS & ESCORTS"
        title="Permits, Regulations & Escort Vehicle Guidance"
        subtitle="Our regulatory resource hub for oversize, overweight, and specialized heavy-haul freight across Canada and North America."
        ...
        <div className="max-w-[1280px] mx-auto px-5 lg:px-10">
          <div className="max-w-3xl mb-12">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-[#F5F6F7] tracking-tight">
              Permits, Escorts & Regional Guidance
            </h2>
          ...
          <div className="mt-20">
            <h3 className="font-display font-bold text-2xl text-[#F5F6F7] mb-8 border-l-4 border-[#CC0000] pl-3">
              Core Regulations & Over-Dimensional Topics
            </h3>
      ...
      {/* Safety & Certification Commitment */}
      <section className="py-20 bg-[#12151B] border-y border-[#262B34]">
        <div className="max-w-[1280px] mx-auto px-5 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 p-8 rounded-3xl bg-[#191D25] border border-[#262B34] flex flex-col gap-6 shadow-2xl">
      ...
      <CtaBanner
        ...
        title="Planning an Oversize or Heavy Haul Move?"
